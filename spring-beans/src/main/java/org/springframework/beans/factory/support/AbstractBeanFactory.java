...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	protected <T> T doGetBean(
		...
		if (sharedInstance != null && args == null) {
			...
			try {
				...
				if (mbd.isSingleton()) {
					//入参是  ObjectFactory  函数式接口，有种回调的感觉
					...
					/**
					 *  TODO
					 *  此时sharedInstance 已经是一个完整对象，为啥还有这个操作？
					 *  因为 sharedInstance 又可能是 FactoryBean,这个方法是个公用的，
					 * 	普通对象创建和 FactoryBean 对象创建都是走此 doGetBean 方法
					 * 	see {@link org.springframework.beans.factory.support.DefaultListableBeanFactory#preInstantiateSingletons}
					 */
	...
	/**
	 * Get the object for the given bean instance, either(两者中的任何一个) the bean
