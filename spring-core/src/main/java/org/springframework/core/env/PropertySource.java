...
/**
 * PropertySource 其实现非常多，其中有MapPropertySource以Map作为source，等等。
 * 在应用中属性源PropertySource来源非常多，有可能是Map对象，也有可能是properies属性文件，
 * 所以Spring又在PropertySource上抽象一层多属性源PropertySources，通过其保持多PropertySource：
 * 其标准实现是易变的多属性源：{@link MutablePropertySources }
 *
 * @param <T>
 */
